        ...
        <div class="row " id="main">
            <div class="col">
                <div class="card text-light bg-dark mt-4" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        <p class="card-text">
                           I came out of apartment and I got lost.I think somebody is pursuing me.I should find a safe place.
                        </p>
...
function continue_story(){
    ...
    var div_col=document.createElement("DIV");
            ...
            tag_p.innerHTML="Hey Suzy! Stop.I'm Jack.Your neighbor.Some rubbers went to the apartment and stole my car.";
...
function continue_story2(){
    ...
    var div_col=document.createElement("DIV");
            ...
            var tag_p=document.createElement("P");
            tag_p.className="card-text";
            tag_p.innerHTML="Hey Suzy.I know you are scared but now everything is ok.So we should comeback home.  ";
            var btn=document.createElement("BUTTON");
