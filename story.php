        ...
        <div class="row " id="main">
            <div class="col">
                <div class="card text-light bg-dark mt-4" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        <p class="card-text">
                           Every where is dark and that voice became silent.No body is here.I am afraid.
                           I think something is there in the light.
                        </p>
...
function continue_story(){
    ...
    var div_col=document.createElement("DIV");
            ...
            tag_p.innerHTML="Hi Suzyyy:)) I'm anabel. Are you looking for me? I'm here.I were waiting for you.You can't run away.Don't try:)";
...
function continue_story2(){
    ...
    var div_col=document.createElement("DIV");
            ...
            var tag_p=document.createElement("P");
            tag_p.className="card-text";
            tag_p.innerHTML="Suzy begged anabel to let her go but anabel killed her and teared her to peicese. Everywhere became bloody and she is dead. ";
            var btn=document.createElement("BUTTON");
